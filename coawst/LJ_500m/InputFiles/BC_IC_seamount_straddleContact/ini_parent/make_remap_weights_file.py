...
grid2_file = 'remap_grid_LJ_500m_parent_seamount_rho.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_LJ_500m_parent_seamount_bilinear_t_to_rho.nc'
interp_file2 = 'remap_weights_LJ_500m_parent_seamount_to_GLBa0.08_bilinear_rho_to_t.nc'
map1_name = 'GLBa0.08 to LJ_500m_parent_seamount Bilinear Mapping'
map2_name = 'LJ_500m_parent_seamount to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_LJ_500m_parent_seamount_u.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_LJ_500m_parent_seamount_bilinear_t_to_u.nc'
interp_file2 = 'remap_weights_LJ_500m_parent_seamount_to_GLBa0.08_bilinear_u_to_t.nc'
map1_name = 'GLBa0.08 to LJ_500m_parent_seamount Bilinear Mapping'
map2_name = 'LJ_500m_parent_seamount to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
...
grid2_file = 'remap_grid_LJ_500m_parent_seamount_v.nc'
interp_file1 = 'remap_weights_GLBa0.08_to_LJ_500m_parent_seamount_bilinear_t_to_v.nc'
interp_file2 = 'remap_weights_LJ_500m_parent_seamount_to_GLBa0.08_bilinear_v_to_t.nc'
map1_name = 'GLBa0.08 to LJ_500m_parent_seamount Bilinear Mapping'
map2_name = 'LJ_500m_parent_seamount to GLBa0.08 Bilinear Mapping'
num_maps = 1
map_method = 'bilinear'
